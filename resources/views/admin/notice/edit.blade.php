  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          @endif
          <div class="container">
          <form role="form" action="{{route('notice.update',[$notice->id])}}" method="POST">
            @method('PUT')
            @csrf
            <div class="card-body">
              <div class="form-group">
                <label for="title">Notice</label>
                <textarea name="notice" class="form-control" placeholder="Enter Notice">{{$notice->notice}}</textarea>
              </div>
